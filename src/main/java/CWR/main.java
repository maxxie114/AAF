...
*/
  ...
  public void onEnable()
  {
    ...
    getLogger().info(TextFormat.colorize("AAF by coke loaded."));
    getDataFolder().mkdirs();
    config = new Config(new File(this.getDataFolder(), "config.yml"), Config.YAML, new LinkedHashMap() {{ put("join-message", "&7%player% joined."); put("quit-message", "&7%player% quit."); put("pvp", "&7%player% was mugged by %killer%"); put("projectile", "&7%player% was hit by a fast moving object"); put("suffocation", "&7%player% was smashed between two hard objects"); put("entity", "&7%player% got mutalated by a mob of some sorts"); put("potion", "&7%player% withered away by some potion"); put("lightning", "&7%player% got fried by nature"); put("void", "&7%player% fell into a black hole"); put("cactus", "&7%player% was pricked"); put("fire", "&7%player% was burnt to a crisp"); put("drowning", "&7%player% drowned"); put("lava", "&7%player% melted"); put("entity-explosion", "&7%player% became shrapnel by mob"); put("block-explosion", "&7%player% became shrapnel from tnt"); put("fall", "&7%player% fell from a great height"); put("suicide", "&7%player% took themselves away");}});
    /*
